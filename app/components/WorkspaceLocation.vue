  ...
  <UContainer class="max-w-screen-2xl mx-auto">
    <div class="max-w-[85rem] sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="grid lg:grid-cols-2 gap-6 mb-12">
        ...
        >
                ...
                <div class="flex items-center">
                  ...
                  <div class="ms-2.5 sm:ms-4">
                    <h4 class="font-semibold text-white">
                      {{ branchesData?.find((b: any) => b.location === 'airport')?.address?.street || '2 Allotey road, East Legon' }}
                    </h4>
                    <p class="text-xs text-white/80">
                      {{ branchesData?.find((b: any) => b.location === 'airport')?.address?.city || 'Accra' }}, {{ branchesData?.find((b: any) => b.location === 'airport')?.address?.country || 'Ghana' }}
                    </p>
                  </div>
                </div>
                <UIcon 
          ...
          <div class="absolute bottom-0 inset-x-0 z-10">
            <div class="flex flex-col h-full p-4 sm:p-6">
              ...
              <p v-if="branchesData?.find((b: any) => b.location === 'airport')?.description" class="text-white/80 text-sm mt-2">
                {{ branchesData.find((b: any) => b.location === 'airport').description }}
              </p>
            </div>
          </div>
        </div>
        ...
        >
            ...
            <div class="p-4 flex flex-col h-full sm:p-6">
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <div class="ms-2.5 sm:ms-4">
                    <h4 class="font-semibold text-white">
                      {{ branchesData?.find((b: any) => b.location === 'tema')?.address?.street || 'Tema Community 16' }}
                    </h4>
                    <p class="text-xs text-white/80">
                      {{ branchesData?.find((b: any) => b.location === 'tema')?.address?.city || 'Tema' }}, {{ branchesData?.find((b: any) => b.location === 'tema')?.address?.country || 'Ghana' }}
                    </p>
                  </div>
                </div>
                <UIcon 
          ...
          <div class="absolute bottom-0 inset-x-0 z-10">
            <div class="flex flex-col h-full p-4 sm:p-6">
              <h3 class="text-lg sm:text-3xl font-semibold text-white group-hover:text-white/80">
                {{ branchesData?.find((b: any) => b.location === 'tema')?.title || 'Tema Branch' }}
                <UBadge v-if="selectedLocation === 'tema'" color="green" class="ml-2">
                  FREE Logo Display
                </UBadge>
              </h3>
              <p v-if="branchesData?.find((b: any) => b.location === 'tema')?.description" class="text-white/80 text-sm mt-2">
                {{ branchesData.find((b: any) => b.location === 'tema').description }}
              </p>
            </div>
          </div>
        </div>
      ...
      <div v-if="selectedLocation" class="mt-16">
        ...
        <div class="w-full">
          ...
          <div v-if="activeTab === 'virtual-office'" class="grid md:grid-cols-3 gap-6">
            ...
            <!-- Oscar Plan -->
            <UCard class="relative border-2 border-red-500 rounded-3xl">
              <template #header>
                <div class="flex justify-between items-start">
                  <div>
     ...
     <AppHeadingTitle class="text-center">
        ...
        <p class="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto text-center">
          Enhance your business with our range of professional services
        </p> 
      </div>
      <!-- Additional Services Content -->
          <div class="mt-10">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <UCard v-for="service in additionalServices" :key="service.name" class="rounded-3xl">
                <template #header>
