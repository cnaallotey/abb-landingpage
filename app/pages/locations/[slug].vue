...
const locations = [
  {
    name: 'Airport West Office',
    address: 'Osu Badu CR 9, Airport West, Accra, Ghana',
    fullAddress: 'ABB Airport City Office\nOsu Badu CR 9, Airport West\nAccra, Ghana',
  ...
  {
    name: 'Tema Office',
    address: 'Paa Grant St. Community 10, Tema, Ghana',
    fullAddress: 'ABB Tema Office\nPaa Grant St. Community 10\nTema, Ghana',
        ...
        <div class="container mx-auto px-4">
          <div class="grid md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/20">
            ...
            <div class="px-4 pt-8 md:pt-0 group cursor-default">
              ...
              <p class="text-white/90 text-sm">{{ currentLocation.whatsapp }}</p>
            </div>
